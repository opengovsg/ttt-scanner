...
def get_name(cell):
    ...
    result = matching_line(cell, "ESSID:")

    if result is None:
        return "<< no name - 01f422bc-2c8c-4dfb-8b36-14b2bc66aa80 >>"
...
def get_extra_tsf(cell):
    """ Gets extra information of a network / cell..
    @param string cell
        A network / cell from iwlist scan.

    @return string
        Extra information of the network.
    """
    return matching_line(cell, "Extra:tsf")

def get_extra_last_beacon(cell):
    """ Gets extra information about the last beacon of a network / cell..
    @param string cell
        A network / cell from iwlist scan.

    @return string
        Extra information on last beacon of the network.
    """
